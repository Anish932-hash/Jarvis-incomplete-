...
class NativeWindowRuntime:
    ...
    def focus_related_window(
        ...
        *,
        ...
        confirmation_title_sequence: Any = None,
        preferred_title: str = "",
        window_title: str = "",
        hwnd: int | None = None,
        pid: int | None = None,
        ...
        return self._call(
            ...
            str(confirmation_hint_query or ""),
            str(confirmation_preferred_title or ""),
            self._encode_title_sequence(confirmation_title_sequence),
