...
def _focus_related_window_impl(payload: Dict[str, Any], *, force_chain: bool = False) -> Dict[str, Any]:
    ...
    return WindowManager().focus_related_window(
        ...
        confirmation_hint_query=str(payload.get("confirmation_hint_query", "")).strip(),
        confirmation_preferred_title=str(payload.get("confirmation_preferred_title", "")).strip(),
        confirmation_title_sequence=payload.get("confirmation_title_sequence", []),
